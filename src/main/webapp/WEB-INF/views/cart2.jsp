...
<h1 align="center">Cart.</h1><br><br>
	...
	<div class="all_check_input_div">
		<input type="checkbox" class="all_check_input input_size_20" id =.all_check_input"check_all" checked="checked"><span class="all_chcek_span">전체선택</span>
	</div>
...
<table class="table table-hover">
   <tr class="active">
   	  <th>&nbsp;</th>   
      <th><p class="text-center">상품명</p></th>
      <th><p class="text-center">단가</p></th>
      <th><p class="text-center">수량</p></th>
      <th><p class="text-center">금액</p></th>
      <th>&nbsp;</th>
   </tr>
    ...
    <tr align="center">
         <td class ="cart_info_td">
             <input type="checkbox" class="individual_cart_checkbox input_size_20" id ="nomal" checked="checked">
...
//체크박스 개별 선택
$(".all_check_input").on("click", "#normal", function() {
    var is_checked = true;

    $(".all_check_input #normal").each(function(){
